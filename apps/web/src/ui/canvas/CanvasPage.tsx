    ...
    <div className="relative flex flex-col gap-4">
      ...
      >
        <button
          ...
          className="absolute right-3 bottom-[calc(7rem+3px)] z-40 rounded-xl border border-slate-200 bg-white/90 px-3 py-2 text-sm font-medium text-slate-700 shadow-sm backdrop-blur hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
